...
class TextDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # print(f"self.query_ids: {self.query_ids}")
        ...
        # print(f"phoneme_mask: {np.shape(np.array(phoneme_mask))} {phoneme_mask}")
        # print(f"char_id: {np.shape(np.array(char_id))} {char_id}")
        # print(f"position_id: {np.shape(np.array(position_id))} {position_id}")
